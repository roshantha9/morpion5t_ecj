...
range_fixed_mutation_prob		= [0.002, 0.05, 0.1]
...
try:	
	# fixed mutation
	for each_val in range_fixed_mutation_prob:		
		run_ffd_for_fixed_mutrate ( each_val )
	
	# dynamic mutation
	for each_val in range_dynamic_mutation_rate:
		run_ffd_for_dynamic_mutrate ( each_val )
